...
import 'package:stockdb/authenticate/bloc.dart';
import 'package:stockdb/data/user_repository.dart';
import 'package:stockdb/utils/EditTextUtils.dart';
              ...
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  BlocProvider.of<LoginBloc>(context).add(SendOtpEvent(
                      phoNo: "+38" + _phoneTextController.value.text));
                }
              },
              color: Colors.orange,
              child: Text(
